...
INTENT_KEYWORDS = {
    "hoi_gia": ["gia", "bao nhieu", "nhieu tien", "phi", "cost"],
    "hoi_ton_kho": ["con hang", "ton kho", "het hang", "con khong", "stock"],
    "tu_van_san_pham": ["tu van", "nen mua", "goi nao", "phu hop", "chay web", "wordpress", "crm"],
    "thanh_toan": ["thanh toan", "chuyen khoan", "vi dien tu", "tra tien", "ck"],
    "giao_hang": ["giao hang", "ban giao", "nhan hang", "email", "tai khoan"],
